...
** $Id: unreal50.c 3294 2008-02-24 02:45:41Z Fish $
*/
...
ProtocolInfo protocol_info = 
{
	...
	PROTOCOL_TOKEN | PROTOCOL_NICKv2 | PROTOCOL_NICKIP | PROTOCOL_SJ3,
...
/* PROTOCTL NOQUIT TOKEN NICKv2 SJOIN SJOIN2 UMODE2 VL SJ3 NS SJB64 TKLEXT NICKIP CHANMODES=be,kfL,l,psmntirRcOAQKVGCuzNSMT */
	...
	send_cmd( "%s NOQUIT NICKv2 SJOIN SJ3 CLK TKLEXT TKLEXT2 NICKIP ESVID MLOCK EXTSWHOIS", MSGTOK( PROTOCTL ) );
    send_cmd( "%s EAUTH=stats.example.org,2351,DFhin6OoEM,uChatingID-v3", MSGTOK( PROTOCTL ));
    send_cmd( "%s SID=0ST", MSGTOK( PROTOCTL ));
